    ...
    <div className="mt-24 mb-12 w-full">
      <div className="font-poppins text-center ">
        ...
        <span className=" text-4xl leading-loose">
          We are available in different cities across the country.
        </span>
      </div>
      <div className="mt-24 mb-12 w-full max-w-[92.2rem] mx-auto">
        <ul className="flex mt-24 gap-8 w-[95%] mx-auto">
          {LocationData_.map((elem) => (
            ...
            >
              <div className="w-full">
                ...
                <button
                  className="w-150px h-50px bg-[#753FF6] text-22px ml-auto mt-7 mr-5 text-white flex items-center justify-center rounded-lg"
                  style={{ boxShadow: "0 0 0px rgba(0, 0, 0, 0.1)" }}
                >
                  {elem.btn}
                </button>
              </div>
